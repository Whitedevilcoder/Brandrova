          ...
          <div>
            ...
            <div className="space-y-6 mb-8">
              <div className="flex items-center gap-4 text-gray-600 dark:text-gray-300">
                ...
                <a href={`mailto:${siteData.email}`} className="hover:text-brand-primary transition-colors text-lg break-all">
                  {siteData.email}
                </a>
              </div>
              ...
              <div className="flex items-center gap-4 text-gray-600 dark:text-gray-300">
                ...
                <a href={siteData.whatsappLink} target="_blank" rel="noreferrer" className="hover:text-brand-accent transition-colors text-lg">
                  {siteData.phoneDisplay}
                </a>
              </div>
            </div>

            <a href={siteData.whatsappLink} target="_blank" rel="noreferrer" className="inline-flex items-center justify-center gap-2 bg-brand-accent hover:bg-green-600 text-white px-8 py-4 rounded-full font-bold text-lg transition-all transform hover:scale-105 shadow-lg shadow-green-500/30 w-full sm:w-auto mt-8">
